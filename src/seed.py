...
with app.app_context():
    ...
    profs = [Profesionals(user_id=users[0].id,
        ...
        tax_address="Calle Mayor 1",nuss="NUSS123456",rating=4.8
        ...
        tax_address="Calle Ocio 2",nuss="NUSS654321",rating=4.6
        ...
        tax_address="Calle Turismo 3",nuss="NUSS789012",rating=4.9
    )]
